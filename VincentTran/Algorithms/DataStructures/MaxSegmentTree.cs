...
namespace VincentTran.Algorithms.DataStructures
{
	...
	/// </summary>
	public class MaxSegmentTree<T> where T : IComparable<T>
	{
		private readonly T[] _tree;
		private readonly int _shift;
		private readonly int _n;

		public MaxSegmentTree(int n, T initialCellValue, T minusInfinity)
			: this(GetArr(n, initialCellValue), minusInfinity)
		{

		}

		public MaxSegmentTree(T[] initialArray, T minusInfinity)
		{
