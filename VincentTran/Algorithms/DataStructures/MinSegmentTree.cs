...
namespace VincentTran.Algorithms.DataStructures
{
	...
	/// </summary>
	public class MinSegmentTree<T> where T : IComparable<T>
	{
		private readonly T[] _tree;
		private readonly int _shift;
		private readonly int _n;

		public MinSegmentTree(int n, T initialCellValue, T plusInfinity)
			: this(GetArr(n, initialCellValue), plusInfinity)
		{

		}

		public MinSegmentTree(T[] initialArray, T plusInfinity)
		{
